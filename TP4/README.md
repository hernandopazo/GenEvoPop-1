...
\- ¿Hace falta realizar algún procesado sobre las lecturas relacionado con la calidad de secuenciación? ¿En qué set de lecturas? De la misma forma que lo hecho en el [TP3](https://github.com/lunfardista/GenEvoPop/tree/master/TP3), procesar el set que haga falta con Trimmomatic, pero combinar los dos archivos desapareados resultantes (si los hubiera) en uno solo.<br/><br/>
